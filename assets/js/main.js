...
(function ($) {
	...
	$("#movie").mouseover(function () {
		$("#movie img").attr("src", "images/pic10-10.jpg");
	});
	$("#movie").mouseout(function () {
		$("#movie img").attr("src", "images/pic10.jpg");
	});

	$("#star").mouseover(function () {
		$("#star img").attr("src", "images/pic11-11.jpg");
	});
	$("#star").mouseout(function () {
		$("#star img").attr("src", "images/pic11.jpg");
	});
})(jQuery);